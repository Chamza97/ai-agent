                        ...
                        <div className=" basis-2/3 p-5 bg-gray-950  rounded-lg">
                            <form className="ring-1 shadow-xs ring-gray-900/5 sm:rounded-xl ">
                                    <div className="border-b border-white/10 pb-5">
                                        <h2 className="text-base/7 font-semibold text-white">AI Agent</h2>
                                        <p className="mt-2 text-sm/6 text-gray-400">
                                            Create your AI Agent's personality and behaviour for twitter.
                                        </p>
                                        <div className="mt-2 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                                            <div className="col-span-full">
                                                <label htmlFor="agent-name" className="block text-sm/6 font-medium text-white">
                                                    Agent name
                                                </label>
                                                <div className="mt-2">
                                                    <div
                                            ...
                                            <div className="col-span-full">
                                                <label htmlFor="personality" className="block text-sm/6 font-medium text-white">
                                                    Personality prompt
                                                </label>
                                                <div className="mt-2">
                                                     <textarea id="personality"
                                                        ...
                                                        className="block w-full rounded-md bg-white/5 px-3 py-1.5 text-base text-white outline-1 -outline-offset-1 outline-white/10 placeholder:text-gray-500  sm:text-sm/6" defaultValue={''}/>
                                                </div>
                                            </div>

                                            <div className="col-span-full">
                                                <label htmlFor="agent-tasks" className="block text-sm/6 font-medium text-white">
                                                    Agent tasks
                                                </label>
                                                <div className="mt-2">
                                            <textarea id="agent-tasks"
                                                      name="agent-tasks"
                                                      rows={2}
