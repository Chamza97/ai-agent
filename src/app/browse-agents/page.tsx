                        ...
                        <div className="basis-2/3 p-5   rounded-lg">
                            <div className="mx-auto max-w-7xl px-6 lg:px-8">
                                <div className="mx-auto max-w-2xl lg:mx-0">
                                    <h2 className="text-2xl font-semibold tracking-tight text-pretty text-white sm:text-2xl">AI Agent Gallery</h2>
                                    <p className="mt-2 text-lg/10 text-gray-500"> Discover AI Agents created by our community.</p>
                                </div>
                                <div className="mx-auto  grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 sm:pt-16 lg:mx-0 lg:max-w-none lg:grid-cols-3">
                                    { posts.map((post) => (
                                        <article key={post.id} className="flex max-w-xl flex-col bg-gray-950 items-start  rounded-lg justify-between">
                                            ...
                                            <div className="group relative">
                                                <h2 className="mt-2 text-sm/6 font-semibold text-white">
                                                    Personality
                                                </h2>
                                                <p className="text-sm/6  text-gray-500">
                                                    {post.personality}
